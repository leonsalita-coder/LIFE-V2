...
export const DEFAULT_GOALS: Goal[] = [
  {
    id: 'peak-athlete',
    title: 'Become a peak athlete in taekwondo and soccer',
    accent: '#8AB4FF',
    weights: { train: 40, fuel: 25, vitals: 20, peak: 15 },
    progress: 0,
  },
]
 ...
 *  Leon has more goals coming — this will get re-weighed once he adds them. */
export const OVERALL_GOAL: Goal = {
  id: 'overall',
  title: 'Lean, powerful, and peaking as a two-sport athlete',
  accent: '#E8C878',
  weights: { train: 40, fuel: 25, vitals: 20, peak: 15 },
  progress: 0,
}
